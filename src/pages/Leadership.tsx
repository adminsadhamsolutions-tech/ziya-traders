...
export default function Leadership() {
  return (
    <div className="pt-24 sm:pt-28 pb-16 sm:pb-20 min-h-screen bg-slate-50 text-slate-800">
      <div className="container-lux px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto">
        <Reveal>
          <Link to="/" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-amber-600 transition-colors mb-6">
        ...
        {/* Executive Bio */}
        <Reveal delay={0.05}>
          <div className="bg-white rounded-3xl border border-slate-200 shadow-lg overflow-hidden mb-10 lg:mb-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
              {/* Photo Section */}
              <div className="relative bg-gradient-to-br from-amber-50 to-slate-100 p-8 flex flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-slate-200">
                <div className="w-44 h-44 sm:w-52 sm:h-52 rounded-full overflow-hidden border-4 border-amber-400 shadow-md bg-white">
                  <img
                    src="/mdimg.jpeg"
                ...
                <div className="mt-5 text-center">
                  <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-rose-100 border border-rose-200 text-rose-800 text-xs font-bold uppercase tracking-wider shadow-sm">
                    <Award className="w-3.5 h-3.5 text-rose-700" /> MD &amp; CEO
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-amber-700">Executive Leadership</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a href="mailto:javithjr2015@gmail.com" className="btn-crimson text-sm px-5 py-2.5 flex items-center justify-center gap-2">
                  ...
                  <a href="tel:+918870380977" className="px-5 py-2.5 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 hover:bg-slate-200 transition text-sm font-semibold flex items-center justify-center gap-2">
                    <Phone className="w-4 h-4 text-amber-600" /> +91-8870380977
                  </a>
                </div>
              </div>
            </div>
        ...
        <Reveal delay={0.1}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10 lg:mb-12">
            {skills.map((skill, i) => (
              <motion.div
                key={skill}
                ...
                whileHover={{ y: -4 }}
                className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 group hover:border-amber-400 transition-all"
              >
                <div className="w-10 h-10 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center shrink-0 group-hover:bg-amber-500 group-hover:text-white transition-colors duration-300">
          ...
          <div className="space-y-6">
            {timeline.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm flex-1 group hover:border-amber-400 transition-all">
                    <div className="flex items-center gap-2 mb-1.5">
                      <Building2 className="w-4 h-4 text-amber-600 shrink-0" />
                      <h3 className="font-display text-base sm:text-lg font-bold text-slate-900">{item.company}</h3>
                    </div>
                    <p className="text-xs sm:text-sm text-rose-700 font-bold mb-2">{item.position}</p>
                  ...
                  <div className="absolute left-4 sm:left-1/2 -translate-x-1/2 hidden sm:flex items-center justify-center z-10">
                    <div className="w-4 h-4 rounded-full bg-amber-500 ring-4 ring-white shadow-sm" />
                  </div>
                </motion.div>
              );
            })}
